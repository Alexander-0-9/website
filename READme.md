...
Dette prosjektet er Om et egen Nettside og en skoleoppgave.  
Målet er å øve på:

- HTML-skjema (a, div, nav, p )
- Design med CSS, med boxer, farger

Nettsiden etterligner et skjema der en ny Netflix-bruker fyller inn informasjon om seg selv.

## Oppgavebeskrivelse

I denne oppgaven skulle vi lage en nettside som ligner på bildet læreren har gitt (Egen Website design).
